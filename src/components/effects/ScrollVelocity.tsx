...
export function ScrollVelocityContainer({
  ...
  return (
    <ScrollVelocityContext.Provider value={velocityFactor}>
      <div className={cn('scroll-velocity-container', className)} {...props}>
        {children}
      </div>
...
function ScrollVelocityRowImpl({
  ...
  return (
    <div ref={containerRef} className={cn('scroll-velocity-row', className)} {...props}>
      <motion.div className="scroll-velocity-track" style={{ x }}>
        {Array.from({ length: numCopies }).map((_, i) => (
          <div
            ...
            className="scroll-velocity-block"
          >
            {children}
          </div>
        ))}
